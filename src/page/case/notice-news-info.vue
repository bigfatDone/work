    ...
    <div class="w1200">
      <div class="breadcrumb">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item :to="{ path: '/noticeNews' }">公告栏</el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: '/noticeNews', query: {id: typeId}}"> {{ type }} </el-breadcrumb-item>
...
<script>
import { getnoticeNewsInfo } from "@/api/base/notice-board";
export default {
  data() {
    return {
      dataInfo: [],
