    ...
    <div class="w1200">
      <div class="breadcrumb">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item :to="{ path: '/publicService' }">公益服务</el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: '/publicService', query: {id: typeId}}">{{ type }}</el-breadcrumb-item>
...
<script>
import { getPublicServiceInfo } from "@/api/base/public-service-info";
export default {
  data() {
    return {
      dataInfo: [],
    ...
    getData(id) {
      getPublicServiceInfo({
        ...
        if (res.success) {
          ...
          this.type = res.returnMap.type;
          this.typeId = res.returnMap.typeId;
        }
      });
    }
  },
