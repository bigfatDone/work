<template>
  <div class="whole">
    <div class="contains">
      ...
      <div class="main" v-if="this.toQualifyList.length">
        <div class="item" v-for="(item, index) in toQualifyList" :key="index">
          <div class="item-left">
            ...
            <div class="item-left-category">
              <span>{{item.NAME}}</span>
              <span class="color-brown">（待检测）</span>
            </div>
      ...
      <div v-if="this.toQualifyList.length" class="pagination">
        <el-pagination
  ...
  methods: {
    ...
    getToQualifyList(val) {
      ...
      record({
        ...
        if (res.success) {
          this.toQualifyList = res.resultList;
    ...
    handlePage(val) {
      ...
      this.getToQualifyList(val);
    }
  },
  mounted() {
    this.getToQualifyList(1);
  }
};
</script>
